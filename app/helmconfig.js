...
const config = {
  link: [
    ...
    //{ rel: 'icon', href: icon },
    //{ rel: 'icon', sizes: '192x192', href: icon },
    // Add to homescreen for Safari on IOS
    //{ rel: 'apple-touch-icon', sizes: '152x152', icon },
    { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css?family=Pacifico|Work+Sans:400,600', type: 'text/css' },
  ...
  meta: [
    ...
    { name: 'description', content: ' An application for trading books with other users' },
    ...
    { name: 'apple-mobile-web-app-title', content: 'Book 2 Book' },
